...
public class EmailGeneratorService {
    ...
    private String geminiApiUrl; //We have to do an API call using URL

    @Value("${gemini.api.key:}") //Injects from application properties
    private String geminiApiKey; //We have to do an API call using API KEY
    ...
    public String generateEmailReply(EmailRequest emailRequest) {
        ...
        //It is built on top of project reactor
